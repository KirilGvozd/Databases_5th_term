...
DATAFILE 'TS_GKV1.dbf'
SIZE 7M
AUTOEXTEND ON NEXT 5M
MAXSIZE 30M;

DROP TABLESPACE TS_GKV INCLUDING CONTENTS;

CREATE TEMPORARY TABLESPACE TS_GKV_TEMP
TEMPFILE 'TS_GKV_TEMP2.dbf'
SIZE 5M
AUTOEXTEND ON NEXT 3M
MAXSIZE 30M;

DROP TABLESPACE TS_GKV_TEMP INCLUDING CONTENTS;
...
SELECT * FROM DBA_ROLE_PRIVS WHERE GRANTEE = 'GKVCORE';
